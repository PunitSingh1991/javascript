...
addTwo(5)
  ...
  */
  ...
  console.log((addTwoToArray([1,2,3,4])))
  /*
  ...
  */
  ...
  console.log((addThreeToArray([1,2,3,4])))
  /*
...
console.log(isAdult(people[3]));
  ...
  */
 const isMale = (obj) => obj.sex ==="M" ? true : false;
  ...
  */
  const isFemale = (obj) => obj.sex === 'F' ? true : false;
  ...
  */
let isGrade = (obj) => obj.grade > 12 ? true : false;
console.log(isGrade(grades[0]));
console.log(isGrade(grades[1]));
console.log(isGrade(grades[2]));
  /*
  ...
  */
  const isGradeB = (obj) => obj.grade <= 12 && obj.grade > 8 ? true : false;
  ...
  */
  let isGradeC = (obj) => obj.grades >= 8 ? true :false;
  console.log(isGradeC(grades[0])); // fales
...
console.log(filterGradeA(grades))
  ...
  */
  ...
  console.log(filter(grades, isGrade))
 ...
 let multiplyByEight = multiplyBy(8);
 console.log(multiplyByEight(12)); // output 96

 let multiplyBy15 = multiplyBy(15);
 console.log(multiplyBy15(12)); //output 180 
